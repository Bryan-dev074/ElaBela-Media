...
Revisión de teclado, 2026-09-10: se conserva Radix Dialog y se prioriza el cierre del visor sobre el detalle que tiene detrás al pulsar Escape durante la apertura. Se descarta otro lightbox; el estado existente de React resuelve el caso, sin nuevas licencias, motores ni dependencias. La regresión comprueba foco de entrada/retorno y cierre por capas en Chrome y Chromium de Playwright; peso medido en `docs/verificacion.md`.
