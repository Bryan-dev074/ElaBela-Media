...
- «Explorar todas las categorías» abre ese diálogo con una consulta general y conserva el estilo creativo. También restablece los filtros de la biblioteca. Se descartó que sólo limpiara filtros: cuando ya estaba todo seleccionado, el botón no mostraba ninguna respuesta. Se reutiliza Radix Dialog y se devuelve el foco al control que lo abrió al cancelar; no se añade ninguna dependencia.
