...
La primera ejecución de CI de esta corrección pasó 21 pruebas de navegador y falló al esperar el foco de retorno del visor. No se reprodujo en siete ejecuciones locales con Chrome 152, tres con CPU limitada a 1/8. Se reforzó la prueba para comprobar foco de entrada y cierre del visor; el segundo CI mostró que la imagen ampliada seguía abierta. Se instaló únicamente el navegador de pruebas Chromium Headless Shell 153 de Playwright en `.local/playwright-browsers`, sin cambiar dependencias ni el navegador del usuario, y allí se reprodujo el fallo.

Escape al abrir rápidamente la imagen podía llegar al diálogo anterior durante el registro de las capas de Radix. El cierre del detalle ahora da prioridad a la imagen ampliada si sigue abierta, conservando la idea y el foco de retorno. La corrección pasó cinco repeticiones con Chromium 153. La regresión final comprueba también que un segundo Escape cierre el detalle; pasó en Chrome 152 y en la suite completa de 22 pruebas con Chromium 153. Typecheck, Biome, 133 pruebas unitarias, build y presupuesto de 114,1 KiB volvieron a pasar. No se añadieron esperas fijas ni reintentos a la prueba. El resultado remoto corresponde a la ejecución del commit final, consultable en GitHub Actions.
