...
1. **Radar creativo:** explorá las ideas con sus imágenes, plataforma, fuente, fecha y motivo. **Investigar con Codex** inicia una búsqueda con la sesión de Codex de esta PC y devuelve los hallazgos al radar. Guardá las favoritas; sus referencias sobreviven a nuevas búsquedas.
